...
ROU_data <- read.csv("./results/ROU_data_corrected.csv")
D_df <- read.csv("results/niche_overlaps_corrected.csv")
...
write.csv(INT.pred, file = "results/spatial_results_corrected.csv", row.names = F)
